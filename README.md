...
Disclaimer: conversion speed heavily depends on CPU frequency and core count.

## Screenshots

Main interface: src/main.png
System monitoring (htop): src/htop.jpg
...
This project is open source. You may use, modify, and distribute it under the terms of the MIT License. See the LICENSE file for details.
